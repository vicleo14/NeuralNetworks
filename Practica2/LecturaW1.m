...
%   encargará de de leer nuestros vectores prototipo que generarán la matiz de 
...
%   También recibe el número de entradas a la red(R) para darle el formato adecuado a 
%   la matriz de pesos. Esto es con el objetivo de hacer el código maás versatil para 
